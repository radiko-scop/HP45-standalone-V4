...
class ImageSlicer:
    ...
    def imageSweeps(self, packed=False):
        ...
        for index in range(self.sweepCount()):
            ...
            if packed:
                yield np.packbits(sweep.T^True, axis=1) # Note the XOR to change 0 into ones. Packbits compress bools into arrays of uint8
            else:
